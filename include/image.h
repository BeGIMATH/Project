...
class Image{
  ...
  public:
    ...
    cv::Mat asotrophic();
    /** @brief A function which helps to to the bilinear interpolation
     *  @param x     -first coordinate of the pixel we want to fill.
     *  @param y     -second coordinate of the pixel we want to fill>
     *  @param Mx1y1 -first  nearest neighboor of the pixel we want to fill.
     *  @param Mx2y1 -second  nearest neighboor of the pixel we want to fill.
     *  @param Mx1y2 -third  nearest neighboor of the pixel we want to fill.
     *  @param Mx2y2 -fourth nearest neighboord of the pixel we want to fill.
     */
     ...
     *  @param dy    -second coordinate of the translation vector with the begining point the original pixel.
     ...
     *  @param sigma  -the key parameter in Gaussian Kernel
     */
    ...
    /** @brief A method to do the simulation of dry fingerprint artefact.
    */
    cv::Mat dry();

    /** @brief A method to do the simulation of moist fingerprint artefact.
    */
    cv::Mat moist();
};
